...
const FilmContent = ({film, isOpen}) => {
  const startBtn = useRef();

  useEffect(() => {
    if(isOpen) startBtn.current.focus();
  }, [isOpen])
  ...
  return(<>
    ...
    <div className="data-wrapper">
        <div className="film-data">
          ...
          <div className="detail-image" role="img" style={{backgroundImage: `url(${film?.poster_path})`}}></div>
          <div className="action-area" data-en-horizontal data-en-active>
            <button className="action-btn play-btn" key='play' ref={startBtn}>
            ...
            <button className="action-btn" key='trailer'>
            ...
            <button className="action-btn" key='playlist'>
